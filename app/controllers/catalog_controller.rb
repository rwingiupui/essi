...
configure_blacklight do |config|
    ...
    config.add_facet_field solr_name('word_boundary'), label: 'Word Boundary', limit:true
    ...
    config.add_index_field solr_name('word_boundary'), label: 'Word Boundary'
    ...
    config.add_show_field solr_name('word_boundary')
